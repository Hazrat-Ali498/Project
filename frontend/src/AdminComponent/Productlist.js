            ...
            <tr key={index}>
              ...
              <td>
                {editProduct === details._id ? (
                  ...
                  <button style={{color:"green", border:"none",fontSize:"25px", borderRadius:"10",marginRight:"5px"}} onClick={() => handleUpdateProduct(details)}>
                    <MdOutlineEdit />
                  </button>
                )}
                <button style={{color:"red",border:"none",fontSize:"25px", marginTop:"10px"}} onClick=    {() => deletProduct(details._id)}>
                <RiDeleteBinLine />
                </button>
              </td>
            </tr>
